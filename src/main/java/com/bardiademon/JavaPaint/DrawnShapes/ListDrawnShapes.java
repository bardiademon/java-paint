...
public final class ListDrawnShapes extends JPanel {
    ...
    public ListDrawnShapes(final Map<String, Tools<?>> tools , final List<WhiteBoard.ArrangePainting> arrangePaintings , DrawnShapes.WhiteBoardRepaint whiteBoardRepaint) {
        this.arrangePaintings = arrangePaintings;
        this.tools = tools;
        this.whiteBoardRepaint = whiteBoardRepaint;
    }
