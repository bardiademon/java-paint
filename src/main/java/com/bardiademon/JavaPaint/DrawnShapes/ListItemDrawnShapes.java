...
public class ListItemDrawnShapes extends JPanel {
    ...
    public ListItemDrawnShapes(final int i , final WhiteBoard.ArrangePainting arrangePainting , final OnChanged onChanged , final Tools<?> tools) {
        this.arrangePainting = arrangePainting;
        ...
        chkFill.addChangeListener(e -> this.onChanged.onChangedFill(this.arrangePainting , chkFill.isSelected()));
        ...
        pnlColor.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ((color = JColorChooser.showDialog(null , "Color" , ListItemDrawnShapes.this.color)) != null) {
                    ...
                    ListItemDrawnShapes.this.onChanged.onChangedColor(ListItemDrawnShapes.this.arrangePainting , color);
        ...
        pnlBgColor.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ((color = JColorChooser.showDialog(null , "Color" , bgColor)) != null) {
                    bgColor = color;
                    ListItemDrawnShapes.this.onChanged.onChangedBackgroundColor(ListItemDrawnShapes.this.arrangePainting , color);
                    pnlBgColor.setBackground(color);
                }
            }
        });

        if (this.arrangePainting.getSelectedTool().equals(SelectedTool.text.name())) {
            ...
            Text shape = textTools.getShape(this.arrangePainting.getIndex());
